...
<div className='flex items-center space-x-2 pt-3 pb-1 text-sm' >
  ...
  />
                ...
                onClick={()=> toggleSection(index)}>
                  <div className='flex items-center gap-2'>
                    <img className={`transform transition-transform ${openSections[index] ? 'rotate-180' : ''}`}
                     src={assets.down_arrow_icon} alt="down_icon" />
      ...
      md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        {
          playerData ? <YouTube videoId={playerData.videoId}
        ...
        src={assets.time_left_clock_icon} alt="time left clock icon" />
             ...
             <div className='flex gap-3 items-center pt-2'>
              ...
              >{courseData.discount}% off</p>
              </div>    

              <div className=' flex items-center text-sm md:text-default gap-2 pt-2
